<?php
  ...
  if( $_SESSION["cuenta"]!="AdminEmpresaurio" && $_SESSION["password"]!="c38aeb85264b3e8382da5fc307f5d00b2bee146c"){
    ...
    if(isset($_POST['submit'])){
        ...
        $sql2="select * from playstation where id='$modificar'";
    ...
    if(isset($_POST['mod'])){
        ...
        $ne="update playstation set id='$uno',producto='$dos',imagen='$tres',precio='$cuatro',descripcion='$cinco',Existencias='$seis' WHERE id='$modificarl'";
...
<body>
 ...
 <div class="contenedor1">
        <div class="contenedor2">
         ...
         $sql = 'select * from playstation';//hacemos cadena con la sentencia mysql que consulta todo el contenido de la tabla
