...
<body>
    ...
    <h2 style="color:white; padding:10px;">Llena todos los campos para agregar el juego</h2>
    <div class="container">
        ...
        <div class="row">
            <div class="col-6">
                  <br>
                  <textarea class="form-control" rows="5" id="descripcion" name="descripcion" placeholder="Descripción del titulo" maxlength="200"></textarea>
            </div>
        </div>
        <div class="row">
                <div class="col-6">
                ...
                <br>
                <input name="userfile" type="file" accept="image/x-png,image/gif,image/jpeg,image/png">
                <br><br>
