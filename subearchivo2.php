...
session_start();
    ...
    if ($conexion->connect_errno){
         ...
         if(((strpos($tipo_archivo, "jpg") || strpos($tipo_archivo, "jpeg") || strpos($tipo_archivo, "png")) && ($tamano_archivo < 100000000))){
                ...
                //hacemos cadena con la sentencia mysql para insertar datos
                 $sql = "INSERT INTO xbox (id, producto, imagen, precio, descripcion, Existencias) VALUES($id,'$nom','$imagen','$precio','$descripcion','$existencias')";
 ...
 echo '<meta http-equiv="refresh" content="0;url=xbox.php">'
?>
